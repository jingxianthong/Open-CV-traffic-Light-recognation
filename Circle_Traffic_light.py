...
def draw_circles_on_image(image_np, boxes):
    """Draw circles around detected traffic lights."""
    ...
    for box in boxes:
        ...
        # Draw rectangle
        draw.rectangle(
            (xmin * im_width, ymin * im_height, xmax * im_width, ymax * im_height),
            outline="red",
            width=5
        )
...
def process_image_from_input_folder(tlc, image_folder_evaluation):
    for filename in os.listdir(image_folder_evaluation):
        ...
        if os.path.isfile(file_to_open):
            ...
            if len(boxes) > 0:
                ...
                image_with_circles = draw_circles_on_image(image_np, boxes)
...
def main():
    ...
    process_image_from_input_folder(tlc, image_folder_evaluation)
